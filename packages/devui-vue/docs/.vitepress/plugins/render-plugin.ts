import { stripScript, stripStyle, stripTemplate, genInlineComponentText } from 'vitepress-theme-demoblock/demoblock/utils'
import os from 'os';

const renderDemoBlock = (content: string, options): {
  template?: string;
  script?: string;
  style?: string;
} => {
